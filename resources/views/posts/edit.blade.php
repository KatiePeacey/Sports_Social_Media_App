...
@section('content')
    <div class="container">
        <div class="px-4 py-3">
            <h1 class="text-2xl font-semibold text-gray-900 sm:pl-2">Edit Post:</h1>
        </div>
        ...
        <form action="{{ route('posts.update', $post->id) }}" method="POST">
            ...
            <div>
                    ...
                    <input id="caption" type="text" name="caption" value="{{ old('caption', $post->caption) }}" class="mt-2 p-2 w-full border border-gray-300 rounded-md" required>
                </div>
            <div>
            ...
            <div class="mt-4">
                ...
                <a href="{{ route('posts.show', $post->player_id) }}" class="text-sm font-semibold text-gray-900">Cancel</a>
